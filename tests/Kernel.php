...
use Dbp\Relay\GreenlightConnectorCampusonlineBundle\DbpRelayGreenlightConnectorCampusonlineBundle;
...
class Kernel extends BaseKernel
{
    ...
    public function registerBundles(): iterable
    {
        ...
        yield new DbpRelayGreenlightConnectorCampusonlineBundle();
    ...
    protected function configureContainer(ContainerConfigurator $container, LoaderInterface $loader)
    {
        ...
        $container->extension('dbp_relay_greenlight_connector_campusonline', [
